...
#saveRDS(Integrated_NA_filtered, file = "./Integrated_NA_filtered.rds")
...
#Integrated_saved <- readRDS("Integrated.rds")
#Integrated_NA_filtered_saved <- readRDS("Integrated_NA_filtered.rds")
#identical(Integrated,Integrated_saved)
#identical(Integrated_NA_filtered,Integrated_NA_filtered_saved)
...
# DGEA for selected genes (Sarah's question 13.12.21)
features <- c('IL2RA','STAT5A','IL2RB','IL32')
persistent.vs.non.persistent.markers.selected.genes <- as.data.frame(FindMarkers(Integrated_NA_filtered ,ident.1 = Persistents, ident.2 = Non_persistents,
                                                                                 logfc.threshold = 0, assay = "RNA",min.pct = 0,features = features))
persistent.vs.non.persistent.markers.selected.genes <- persistent.vs.non.persistent.markers.selected.genes[,c(2,5)]
write.xlsx(persistent.vs.non.persistent.markers.selected.genes, 'persistent.vs.non.persistent.markers.selected.genes.xlsx',row.names = TRUE)
...
Positive_CTaas_in_Acute <- Positive_CTaas_in_Acute[! Positive_CTaas_in_Acute %in% kicks[1:2]]
Positive_CTaas_in_Recovered <- Positive_CTaas_in_Recovered[! Positive_CTaas_in_Recovered %in% kicks[3]]
...
#########
# Continuing after line 857: CD39
DefaultAssay(Integrated) <- "RNA"
FeaturePlot(Integrated,features = c("CD3D","CD8A","ENTPD1","NT5E"))
