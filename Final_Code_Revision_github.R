...
# Individual UMAPs for the acute severities, only one color per plot
...
# Make the plot
Sarahs_plot_CTaas <- Frequency_trend$CTaa
output2<- matrix(ncol=3, nrow=length(Sarahs_plot_CTaas))
i <- 0
while (i<length(Sarahs_plot_CTaas)) {
  Acute_expression_levels <- Integrated_NA_filtered@assays$RNA@data["MKI67",rownames(Integrated_NA_filtered@meta.data[Integrated_NA_filtered@meta.data$CTaa==Sarahs_plot_CTaas[i+1]&
                                            Integrated_NA_filtered@meta.data$Timepoint=="Acute",])]
  Recovered_expression_levels <- Integrated_NA_filtered@assays$RNA@data["MKI67",rownames(Integrated_NA_filtered@meta.data[Integrated_NA_filtered@meta.data$CTaa==Sarahs_plot_CTaas[i+1]&
                                                                                                                    Integrated_NA_filtered@meta.data$Timepoint=="Recovered",])]
  ...
  output2[i+1,1] <- Sarahs_plot_CTaas[i+1]
...
Sarahs_plot_CTaas <- last_Frequency_trend$CTaa
output2<- matrix(ncol=3, nrow=length(Sarahs_plot_CTaas))
i <- 0
while (i<length(Sarahs_plot_CTaas)) {
  Acute_score_levels <- Integrated_noNA@meta.data[Integrated_noNA@meta.data$CTaa==Sarahs_plot_CTaas[i+1]&
                                                          Integrated_noNA@meta.data$Timepoint=="Acute",42]
  Recovered_score_levels <- Integrated_noNA@meta.data[Integrated_noNA@meta.data$CTaa==Sarahs_plot_CTaas[i+1]&
...
remove(active_markers,Integrated_noNA,last_Frequency_trend,melted_output2,output2,resting_markers,Acute_score_levels,i,Recovered_score_levels,Sarahs_plot_CTaas)
...
i <- 0
while (i<length(Sarahs_plot_CTaas)) {
  Acute_expression_levels <- Integrated_NA_filtered@assays$Protein@data["CCR7.1",rownames(Integrated_NA_filtered@meta.data[Integrated_NA_filtered@meta.data$CTaa==Sarahs_plot_CTaas[i+1]&
                                                                                                                             Integrated_NA_filtered@meta.data$Timepoint=="Acute",])]
  Recovered_expression_levels <- Integrated_NA_filtered@assays$Protein@data["CCR7.1",rownames(Integrated_NA_filtered@meta.data[Integrated_NA_filtered@meta.data$CTaa==Sarahs_plot_CTaas[i+1]&
                                                                                                                                 Integrated_NA_filtered@meta.data$Timepoint=="Recovered",])]
  Acute_expression_levels <- unname(Acute_expression_levels)
  Recovered_expression_levels <- unname(Recovered_expression_levels)
  Acute_expression_levels <- mean(Acute_expression_levels)
...
remove(melted_output2,output2,Acute_expression_levels,i,Recovered_expression_levels,Sarahs_plot_CTaas)
